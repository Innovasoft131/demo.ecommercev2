        ...
        <div class="col md-4">
            <div class="form-group ">
                <div class="input-group">
                    <div class="col-10"><p id="titulo" >Productos para Niños</p></div>
                    <?php
                        $item = "genero";
                        $valor = "Niños";
                        ...
                        if(!isset($_GET["pagina"])){
                            echo '<script> window.location = "index.php?ruta=articulos-para-ninios&pagina=1";</script>';
...
<nav aria-label="Page navigation example">
  <ul class="pagination justify-content-center">
    <li class="page-item <?php echo $_GET["pagina"] <= 1 ? 'disabled' : '' ?>">
      <a class="page-link" href="index.php?ruta=articulos-para-ninios&pagina=<?php echo $_GET["pagina"]-1; ?>" tabindex="-1">Anterior</a>
    </li>
    <?php
        for ($i=0; $i < $paginas; $i++):
    ?>
    <li class="page-item  <?php echo $_GET["pagina"]==$i+1 ? 'active' : '' ?>">
        <a class="page-link" href="index.php?ruta=articulos-para-ninios&pagina=<?php echo $i+1; ?>"><?php echo $i+1; ?></a>
    </li>
    <?php endfor ?>
    <li class="page-item <?php echo $_GET["pagina"] >= $paginas ? 'disabled' : '' ?>">
      <a class="page-link" href="index.php?ruta=articulos-para-ninios&pagina=<?php echo $_GET["pagina"]+1; ?>">Siguiente</a>
    </li>
  </ul>
</nav>
