        ...
        <div class="col md-4">
            <div class="form-group ">
                <div class="input-group">
                    <div class="col-10"><p id="titulo" >Productos para Oferta</p></div>
                    <?php
                        $item = "estado";
                        $valor = "Oferta";
                        ...
                        if(!isset($_GET["pagina"])){
                            echo '<script> window.location = "index.php?ruta=articulos-en-oferta&pagina=1";</script>';
...
<nav aria-label="Page navigation example">
  <ul class="pagination pagination-circle justify-content-center">
    <li class="page-item <?php echo $_GET["pagina"] <= 1 ? 'disabled' : '' ?>">
      <a class="page-link" href="index.php?ruta=articulos-en-oferta&pagina=<?php echo $_GET["pagina"]-1; ?>" tabindex="-1">Anterior</a>
    </li>
    <?php
        for ($i=0; $i < $paginas; $i++):
    ?>
    <li class="page-item  <?php echo $_GET["pagina"]==$i+1 ? 'active' : '' ?>">
        <a class="page-link" href="index.php?ruta=articulos-en-oferta&pagina=<?php echo $i+1; ?>"><?php echo $i+1; ?></a>
    </li>
    <?php endfor ?>
    <li class="page-item <?php echo $_GET["pagina"] >= $paginas ? 'disabled' : '' ?>">
      <a class="page-link" href="index.php?ruta=articulos-en-oferta&pagina=<?php echo $_GET["pagina"]+1; ?>">Siguiente</a>
    </li>
  </ul>
</nav>
