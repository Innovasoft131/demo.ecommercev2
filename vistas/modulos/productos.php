    ...
    <div class="content-page">
        ...
        <?php
            ...
            if(!isset($_GET["pagina"])){
                ...
                echo '<script> window.location = "index.php?ruta=productos&pagina=1&item='.$_GET["item"].'";</script>';
            ...
            if($_GET["pagina"] > $paginas || $_GET["pagina"] <= 0 ){
                ...
                echo '<script> window.location = "index.php?ruta=productos&pagina=1&item=""";</script>';
            } 
...
<div class="center">
  <ul class="pagination">
    <li><a href="index.php?ruta=productos&pagina=<?php echo $_GET["pagina"]-1; ?>&item=<?php if($items != ""){ echo $items;} ?>">Anterior</a></li>
    <?php
        for ($i=0; $i < $paginas; $i++):
    ?>
    <li><a class="<?php echo $_GET["pagina"]==$i+1 ? 'active' : '' ?>" href="index.php?ruta=productos&pagina=<?php echo $i+1; ?>&item=<?php if($items != ""){ echo $items;} ?>"><?php echo $i+1; ?></a></li>
    <?php endfor ?>
    <li><a href="index.php?ruta=productos&pagina=<?php echo $_GET["pagina"]+1;?>&item=<?php if($items != ""){ echo $items;} ?>">Siguiente</a></li>
  </ul>
</div>